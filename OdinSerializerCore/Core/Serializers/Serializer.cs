...
#pragma warning disable 618
    ...
    public abstract class Serializer
    {
        ...
        private static Serializer Create(Type type, bool allowWeakfallback)
        {
            ...
            try
            {
                ...
                else if (FormatterUtilities.IsPrimitiveType(type))
                {
                    ...
                    {
                        System.Console.WriteLine("Failed to find primitive serializer for " + type.Name);
                    }
                }
                else
                {
        ...
        {
            System.Console.WriteLine("No AOT serializer was pre-generated for the type '" + type.GetNiceFullName() + "'. " +
